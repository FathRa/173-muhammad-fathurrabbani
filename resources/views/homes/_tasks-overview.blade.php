<section>
    <div class="flex items-center justify-between border-0 border-b-2 border-gray-500">
        ...
        <nav>
            <ul class="flex gap-5">
                <li class="border-2 border-black border-b-white p-2">All Tasks</li>
                <li class="p-2">Open Tasks</li>
                <li class="p-2">On Progress Tasks</li>
                <li class="p-2">Closed Tasks</li>
            </ul>
        </nav>
    </div>

    <div class="grid grid-flow-row gap-2 py-10">
        <div class="flex justify-between rounded-md border border-l-4 border-gray-300 border-l-green-500 p-3 shadow-md">
            <div>
        ...
        <div class="flex justify-between rounded-md border border-l-4 border-gray-300 border-l-red-500 p-3 shadow-md">
            <div>
                <header class="flex gap-2">
                    <h3 class="text-lg">Title Example</h3>
                    <div>
